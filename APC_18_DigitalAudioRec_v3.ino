// ----------------------------------------------------
// Digital Audio Recorder for Arduino
// Darren Yates - 11 April 2014
// modified by Nick Crescimanno - Electric Sheep Labs - 5 Feb 2016
//
// Includes the SdFat library - https://code.google.com/p/sdfatlib/downloads/list
//
/*
 * use this code in conjuction with an amplified audio signal, which 
 * ideally is biased to 2.5 V steady state and does not drop below 0 V.
 * Wire input into analog input pin 5, don't forget to establish common 
 * ground bw arduino and you mic amp!
 */
// ----------------------------------------------------
...
const int chipSelect = 53; //set to 4 for Arduino Uno (and plug in SS to pin 4), 53 for Mega
...
const unsigned long duration = 10000000; // duration 0f recording in microseconds 
...
while(duration > (micros()-timeCheck))
{
